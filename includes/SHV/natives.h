...
namespace ENTITY
{
	...
	static void APPLY_FORCE_TO_ENTITY_CENTER_OF_MASS(Entity entity, int forceFlags, float x, float y, float z, Any p5, BOOL isDirRel, BOOL isMassRel, BOOL p8) { invoke<Void>(0x18FF00FC7EFF559E, entity, forceFlags, x, y, z, p5, isDirRel, isMassRel, p8); } // 0x18FF00FC7EFF559E 0x28924E98
	static void APPLY_FORCE_TO_ENTITY(Entity entity, int forceFlags, float x, float y, float z, float offsetX, float offsetY, float offsetZ, int boneIndex, BOOL isDirRel, BOOL ignoreUpVec, BOOL isMassRel, BOOL p12, BOOL p13) { invoke<Void>(0xC5F68BE9613E2D18, entity, forceFlags, x, y, z, offsetX, offsetY, offsetZ, boneIndex, isDirRel, ignoreUpVec, isMassRel, p12, p13); } // 0xC5F68BE9613E2D18 0xC1C0855A
...
namespace OBJECT
{
	...
	static void SET_OBJECT_PHYSICS_PARAMS(Object object, float weight, float gravity, float dragA, float dragB, float dragC, float dragRotA, float dragRotB, float dragRotC, float p9, float maxRotVel, float density) { invoke<Void>(0xF6DF6E90DE7DF90F, object, weight, gravity, dragA, dragB, dragC, dragRotA, dragRotB, dragRotC, p9, maxRotVel, density); } // 0xF6DF6E90DE7DF90F 0xE8D11C58
...
namespace CAM
{
	...
	static void ATTACH_CAM_TO_ENTITY(Any cam, Entity entity, float xOffset, float yOffset, float zOffset, BOOL rel) { invoke<Void>(0xFEDB7D269E8C60E3, cam, entity, xOffset, yOffset, zOffset, rel); } // 0xFEDB7D269E8C60E3 0xAD7C45F6
